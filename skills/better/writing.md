...
How copy renders (capitalization via `text-transform`, truncation, smart punctuation) is covered in `typography.md`; error markup and announcements (`aria-invalid`, live regions) in `accessibility.md`; room for translated strings in `layout.md`.
