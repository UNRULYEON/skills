...
local_name: better-layout
upstream_repo: jakubkrehel/skills
upstream_path: skills/better-layout
...
and re-run `bun scripts/external-skills.ts sync better-layout --write`.

- Source repo: [jakubkrehel/skills](https://github.com/jakubkrehel/skills)
- Source path: `skills/better-layout`
