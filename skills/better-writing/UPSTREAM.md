...
local_name: better-writing
upstream_repo: jakubkrehel/skills
upstream_path: skills/better-writing
...
and re-run `bun scripts/external-skills.ts sync better-writing --write`.

- Source repo: [jakubkrehel/skills](https://github.com/jakubkrehel/skills)
- Source path: `skills/better-writing`
